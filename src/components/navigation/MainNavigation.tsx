          ...
          <div className="main-navigation__menu" ref={dropdownRef}>
            <div className="main-navigation__menu-item-wrapper">
              ...
              {openDropdown === 'dashboard' && (
                <div className="main-navigation__dropdown" id={dropdownId('dashboard')} role="menu" aria-label="Dashboard submenu">
              ...
              <>
                <div className="main-navigation__menu-item-wrapper">
                  ...
                  {openDropdown === 'topology' && (
                    <div className="main-navigation__dropdown" id={dropdownId('topology')} role="menu" aria-label="Topology submenu">
                ...
                <div className="main-navigation__menu-item-wrapper">
                  ...
                  {openDropdown === 'template' && (
                    <div className="main-navigation__dropdown" id={dropdownId('template')} role="menu" aria-label="Template submenu">
              ...
              <>
                ...
                <div className="main-navigation__menu-item-wrapper">
                  ...
                  {openDropdown === 'settings' && (
                    <div className="main-navigation__dropdown" id={dropdownId('settings')} role="menu" aria-label="Settings submenu">
