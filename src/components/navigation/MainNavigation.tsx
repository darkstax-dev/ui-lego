      ...
      <div className="main-navigation__container">
        ...
        <div className="main-navigation__right">
          ...
          <div className="main-navigation__actions">
            <button className="main-navigation__action-btn" aria-label="Theme toggle">
            ...
            <button className="main-navigation__action-btn" aria-label="Security">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <button className="main-navigation__action-btn" aria-label="Settings">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <button className="main-navigation__action-btn" aria-label="Notifications">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
